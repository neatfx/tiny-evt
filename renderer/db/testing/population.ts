...
async function populateBooks() {
  ...
  book4.nameWords = ['三体', '黑暗', '森林', '刘慈欣', '科幻']
  ...
  book7.nameWords = ['under', 'dome', 'stephen', 'king', '小说']
