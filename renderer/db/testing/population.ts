...
async function populateBooks() {
  ...
  // book1.nameTokens = book1.nameTokens?.concat([book1.author, ...book1.categories])
  ...
  // book3.nameTokens = book3.nameTokens?.concat([book3.author, ...book3.categories])
  ...
  // book4.nameTokens = book4.nameTokens?.concat([book4.author, ...book4.categories])
  ...
  // book5.nameTokens = book5.nameTokens?.concat([book5.author, ...book5.categories])
  ...
  // book6.nameTokens = book6.nameTokens?.concat([book6.author, ...book6.categories])
  ...
  // book7.nameTokens = book7.nameTokens?.concat([book7.author, ...book7.categories])
